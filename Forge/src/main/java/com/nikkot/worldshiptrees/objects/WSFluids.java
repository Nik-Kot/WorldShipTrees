...
public class WSFluids {
    ...
    public static final RegistryObject<WSFluidType> FLUID_TYPE_TREE_SAP = WSRegisters.fluidTypeRegister.register("tree_sap_type", () -> new WSFluidType(null, null, null, 0, null, FluidType.Properties.create()));
