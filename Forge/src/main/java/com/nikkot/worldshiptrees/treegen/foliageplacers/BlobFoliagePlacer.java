...
public class BlobFoliagePlacer extends WorldShipFoliagePlacer {
   ...
   protected WorldShipFoliagePlacerType<?> type() {
      return WorldShipFoliagePlacerType.BLOB_FOLIAGE_PLACER;
   }

   protected void createFoliage(LevelSimulatedReader p_225520_, BiConsumer<BlockPos, BlockState> p_225521_, RandomSource p_225522_, WorldShipTreeConfiguration p_225523_, int p_225524_, FoliageAttachment p_225525_, int p_225526_, int p_225527_, int p_225528_) {
   ...
   public int foliageHeight(RandomSource p_225516_, int p_225517_, WorldShipTreeConfiguration p_225518_) {
      return this.height;
   }
