...
public class BushFoliagePlacer extends BlobFoliagePlacer {
   ...
   protected WorldShipFoliagePlacerType<?> type() {
      return WorldShipFoliagePlacerType.BUSH_FOLIAGE_PLACER;
   }

   protected void createFoliage(LevelSimulatedReader p_225537_, BiConsumer<BlockPos, BlockState> p_225538_, RandomSource p_225539_, WorldShipTreeConfiguration p_225540_, int p_225541_, FoliageAttachment p_225542_, int p_225543_, int p_225544_, int p_225545_) {
