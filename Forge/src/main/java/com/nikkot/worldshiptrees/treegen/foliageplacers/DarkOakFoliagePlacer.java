...
public class DarkOakFoliagePlacer extends WorldShipFoliagePlacer {
   ...
   protected WorldShipFoliagePlacerType<?> type() {
      return WorldShipFoliagePlacerType.DARK_OAK_FOLIAGE_PLACER;
   }

   protected void createFoliage(LevelSimulatedReader p_225558_, BiConsumer<BlockPos, BlockState> p_225559_, RandomSource p_225560_, WorldShipTreeConfiguration p_225561_, int p_225562_, FoliageAttachment p_225563_, int p_225564_, int p_225565_, int p_225566_) {
   ...
   public int foliageHeight(RandomSource p_225554_, int p_225555_, WorldShipTreeConfiguration p_225556_) {
      return 4;
   }
