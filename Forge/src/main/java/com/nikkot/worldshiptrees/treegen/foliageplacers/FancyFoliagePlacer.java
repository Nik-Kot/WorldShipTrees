...
public class FancyFoliagePlacer extends BlobFoliagePlacer {
   ...
   protected WorldShipFoliagePlacerType<?> type() {
      return WorldShipFoliagePlacerType.FANCY_FOLIAGE_PLACER;
   }

   protected void createFoliage(LevelSimulatedReader p_225582_, BiConsumer<BlockPos, BlockState> p_225583_, RandomSource p_225584_, WorldShipTreeConfiguration p_225585_, int p_225586_, FoliageAttachment p_225587_, int p_225588_, int p_225589_, int p_225590_) {
