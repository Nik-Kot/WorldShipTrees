...
public class MegaPineFoliagePlacer extends WorldShipFoliagePlacer {
   ...
   protected WorldShipFoliagePlacerType<?> type() {
      return WorldShipFoliagePlacerType.MEGA_PINE_FOLIAGE_PLACER;
   }

   protected void createFoliage(LevelSimulatedReader p_225678_, BiConsumer<BlockPos, BlockState> p_225679_, RandomSource p_225680_, WorldShipTreeConfiguration p_225681_, int p_225682_, FoliageAttachment p_225683_, int p_225684_, int p_225685_, int p_225686_) {
   ...
   public int foliageHeight(RandomSource p_225674_, int p_225675_, WorldShipTreeConfiguration p_225676_) {
