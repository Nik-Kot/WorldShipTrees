...
public class PineFoliagePlacer extends WorldShipFoliagePlacer {
   ...
   protected WorldShipFoliagePlacerType<?> type() {
      return WorldShipFoliagePlacerType.PINE_FOLIAGE_PLACER;
   }

   protected void createFoliage(LevelSimulatedReader p_225702_, BiConsumer<BlockPos, BlockState> p_225703_, RandomSource p_225704_, WorldShipTreeConfiguration p_225705_, int p_225706_, FoliageAttachment p_225707_, int p_225708_, int p_225709_, int p_225710_) {
      int i = 0;
   ...
   public int foliageHeight(RandomSource p_225698_, int p_225699_, WorldShipTreeConfiguration p_225700_) {
