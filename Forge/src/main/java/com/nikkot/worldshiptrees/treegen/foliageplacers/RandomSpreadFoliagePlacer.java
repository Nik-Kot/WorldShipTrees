...
public class RandomSpreadFoliagePlacer extends WorldShipFoliagePlacer {
   ...
   protected WorldShipFoliagePlacerType<?> type() {
      return WorldShipFoliagePlacerType.RANDOM_SPREAD_FOLIAGE_PLACER;
   }

   protected void createFoliage(LevelSimulatedReader p_225723_, BiConsumer<BlockPos, BlockState> p_225724_, RandomSource p_225725_, WorldShipTreeConfiguration p_225726_, int p_225727_, FoliageAttachment p_225728_, int p_225729_, int p_225730_, int p_225731_) {
   ...
   public int foliageHeight(RandomSource p_225719_, int p_225720_, WorldShipTreeConfiguration p_225721_) {
