...
public class SpruceFoliagePlacer extends WorldShipFoliagePlacer {
   ...
   protected WorldShipFoliagePlacerType<?> type() {
      return WorldShipFoliagePlacerType.SPRUCE_FOLIAGE_PLACER;
   }

   protected void createFoliage(LevelSimulatedReader p_225744_, BiConsumer<BlockPos, BlockState> p_225745_, RandomSource p_225746_, WorldShipTreeConfiguration p_225747_, int p_225748_, FoliageAttachment p_225749_, int p_225750_, int p_225751_, int p_225752_) {
   ...
   public int foliageHeight(RandomSource p_225740_, int p_225741_, WorldShipTreeConfiguration p_225742_) {
