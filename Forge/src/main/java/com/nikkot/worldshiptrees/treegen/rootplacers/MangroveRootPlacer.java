...
public class MangroveRootPlacer extends WorldShipRootPlacer {
   ...
   public boolean placeRoots(LevelSimulatedReader p_225840_, BiConsumer<BlockPos, BlockState> p_225841_, RandomSource p_225842_, BlockPos p_225843_, BlockPos p_225844_, WorldShipTreeConfiguration p_225845_) {
   ...
   protected void placeRoot(LevelSimulatedReader p_225834_, BiConsumer<BlockPos, BlockState> p_225835_, RandomSource p_225836_, BlockPos p_225837_, WorldShipTreeConfiguration p_225838_) {
   ...
   protected WorldShipRootPlacerType<?> type() {
      return WorldShipRootPlacerType.MANGROVE_ROOT_PLACER;
   }
}