...
public class AlterGroundDecorator extends WorldShipTreeDecorator {
   ...
   protected WorldShipTreeDecoratorType<?> type() {
      return WorldShipTreeDecoratorType.ALTER_GROUND;
   }

   public void place(Context p_225969_) {
   ...
   private void placeCircle(Context p_225971_, BlockPos p_225972_) {
      for(int i = -2; i <= 2; ++i) {
         for(int j = -2; j <= 2; ++j) {
   ...
   private void placeBlockAt(Context p_225974_, BlockPos p_225975_) {
      for(int i = 2; i >= -3; --i) {
