...
public class AttachedToLeavesDecorator extends WorldShipTreeDecorator {
   ...
   public void place(Context p_226000_) {
   ...
   private boolean hasRequiredEmptyBlocks(Context p_226002_, BlockPos p_226003_, Direction p_226004_) {
   ...
   protected WorldShipTreeDecoratorType<?> type() {
      return WorldShipTreeDecoratorType.ATTACHED_TO_LEAVES;
   }
}