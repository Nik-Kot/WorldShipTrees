...
public class DarkOakTrunkPlacer extends WorldShipTrunkPlacer {
   ...
   protected WorldShipTrunkPlacerType<?> type() {
      return WorldShipTrunkPlacerType.DARK_OAK_TRUNK_PLACER;
   }

   public List<WorldShipFoliagePlacer.FoliageAttachment> placeTrunk(LevelSimulatedReader p_226086_, BiConsumer<BlockPos, BlockState> p_226087_, RandomSource p_226088_, int p_226089_, BlockPos p_226090_, WorldShipTreeConfiguration p_226091_) {
      ...
      for(int i2 = 0; i2 < p_226089_; ++i2) {
         ...
         if (WorldShipTreeFeature.isAirOrLeaves(p_226086_, blockpos1)) {
      ...
      list.add(new WorldShipFoliagePlacer.FoliageAttachment(new BlockPos(j1, l1, k1), 0, true));
      ...
      for(int l2 = -1; l2 <= 2; ++l2) {
         for(int i3 = -1; i3 <= 2; ++i3) {
            if ((l2 < 0 || l2 > 1 || i3 < 0 || i3 > 1) && p_226088_.nextInt(3) <= 0) {
               ...
               list.add(new WorldShipFoliagePlacer.FoliageAttachment(new BlockPos(j1 + l2, l1, k1 + i3), 0, false));
            }
         }
      }
