...
public class FancyTrunkPlacer extends WorldShipTrunkPlacer {
   ...
   protected WorldShipTrunkPlacerType<?> type() {
      return WorldShipTrunkPlacerType.FANCY_TRUNK_PLACER;
   }

   public List<WorldShipFoliagePlacer.FoliageAttachment> placeTrunk(LevelSimulatedReader p_226093_, BiConsumer<BlockPos, BlockState> p_226094_, RandomSource p_226095_, int p_226096_, BlockPos p_226097_, WorldShipTreeConfiguration p_226098_) {
      int i = 5;
      int j = p_226096_ + 2;
      ...
      list.add(new FoliageCoords(p_226097_.above(j1), i1));
      ...
      List<WorldShipFoliagePlacer.FoliageAttachment> list1 = Lists.newArrayList();
   ...
   private boolean makeLimb(LevelSimulatedReader p_226108_, BiConsumer<BlockPos, BlockState> p_226109_, RandomSource p_226110_, BlockPos p_226111_, BlockPos p_226112_, boolean p_226113_, WorldShipTreeConfiguration p_226114_) {
   ...
   private void makeBranches(LevelSimulatedReader p_226100_, BiConsumer<BlockPos, BlockState> p_226101_, RandomSource p_226102_, int p_226103_, BlockPos p_226104_, List<FoliageCoords> p_226105_, WorldShipTreeConfiguration p_226106_) {
   ...
   static class FoliageCoords {
      final WorldShipFoliagePlacer.FoliageAttachment attachment;
      private final int branchBase;

      public FoliageCoords(BlockPos p_70140_, int p_70141_) {
         this.attachment = new WorldShipFoliagePlacer.FoliageAttachment(p_70140_, 0, false);
