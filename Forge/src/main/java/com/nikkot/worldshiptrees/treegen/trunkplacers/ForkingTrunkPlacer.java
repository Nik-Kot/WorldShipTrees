...
public class ForkingTrunkPlacer extends WorldShipTrunkPlacer {
   ...
   protected WorldShipTrunkPlacerType<?> type() {
      return WorldShipTrunkPlacerType.FORKING_TRUNK_PLACER;
   }

   public List<WorldShipFoliagePlacer.FoliageAttachment> placeTrunk(LevelSimulatedReader p_226116_, BiConsumer<BlockPos, BlockState> p_226117_, RandomSource p_226118_, int p_226119_, BlockPos p_226120_, WorldShipTreeConfiguration p_226121_) {
      ...
      if (optionalint.isPresent()) {
         list.add(new WorldShipFoliagePlacer.FoliageAttachment(new BlockPos(k, optionalint.getAsInt(), l), 1, false));
      }
      ...
      if (direction1 != direction) {
         ...
         if (optionalint.isPresent()) {
            list.add(new WorldShipFoliagePlacer.FoliageAttachment(new BlockPos(k, optionalint.getAsInt(), l), 0, false));
         }
      }
