...
public class GiantTrunkPlacer extends WorldShipTrunkPlacer {
   ...
   protected WorldShipTrunkPlacerType<?> type() {
      return WorldShipTrunkPlacerType.GIANT_TRUNK_PLACER;
   }

   public List<WorldShipFoliagePlacer.FoliageAttachment> placeTrunk(LevelSimulatedReader p_226123_, BiConsumer<BlockPos, BlockState> p_226124_, RandomSource p_226125_, int p_226126_, BlockPos p_226127_, WorldShipTreeConfiguration p_226128_) {
      ...
      return ImmutableList.of(new WorldShipFoliagePlacer.FoliageAttachment(p_226127_.above(p_226126_), 0, true));
   }

   private void placeLogIfFreeWithOffset(LevelSimulatedReader p_226130_, BiConsumer<BlockPos, BlockState> p_226131_, RandomSource p_226132_, BlockPos.MutableBlockPos p_226133_, WorldShipTreeConfiguration p_226134_, BlockPos p_226135_, int p_226136_, int p_226137_, int p_226138_) {
