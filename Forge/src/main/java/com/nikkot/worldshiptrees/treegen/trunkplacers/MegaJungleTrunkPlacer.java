...
public class MegaJungleTrunkPlacer extends GiantTrunkPlacer {
   ...
   protected WorldShipTrunkPlacerType<?> type() {
      return WorldShipTrunkPlacerType.MEGA_JUNGLE_TRUNK_PLACER;
   }

   public List<WorldShipFoliagePlacer.FoliageAttachment> placeTrunk(LevelSimulatedReader p_226140_, BiConsumer<BlockPos, BlockState> p_226141_, RandomSource p_226142_, int p_226143_, BlockPos p_226144_, WorldShipTreeConfiguration p_226145_) {
      ...
      for(int i = p_226143_ - 2 - p_226142_.nextInt(4); i > p_226143_ / 2; i -= 2 + p_226142_.nextInt(4)) {
         ...
         list.add(new WorldShipFoliagePlacer.FoliageAttachment(p_226144_.offset(j, i, k), -2, false));
      }
