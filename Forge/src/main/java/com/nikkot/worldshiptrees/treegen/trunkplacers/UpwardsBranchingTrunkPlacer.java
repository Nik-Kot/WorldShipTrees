...
public class UpwardsBranchingTrunkPlacer extends WorldShipTrunkPlacer {
   ...
   protected WorldShipTrunkPlacerType<?> type() {
      return WorldShipTrunkPlacerType.UPWARDS_BRANCHING_TRUNK_PLACER;
   }

   public List<WorldShipFoliagePlacer.FoliageAttachment> placeTrunk(LevelSimulatedReader p_226225_, BiConsumer<BlockPos, BlockState> p_226226_, RandomSource p_226227_, int p_226228_, BlockPos p_226229_, WorldShipTreeConfiguration p_226230_) {
      List<WorldShipFoliagePlacer.FoliageAttachment> list = Lists.newArrayList();
      ...
      for(int i = 0; i < p_226228_; ++i) {
         ...
         if (i == p_226228_ - 1) {
            list.add(new WorldShipFoliagePlacer.FoliageAttachment(blockpos$mutableblockpos.set(p_226229_.getX(), j + 1, p_226229_.getZ()), 0, false));
         }
      }
   ...
   private void placeBranch(LevelSimulatedReader p_226213_, BiConsumer<BlockPos, BlockState> p_226214_, RandomSource p_226215_, int p_226216_, WorldShipTreeConfiguration p_226217_, List<WorldShipFoliagePlacer.FoliageAttachment> p_226218_, BlockPos.MutableBlockPos p_226219_, int p_226220_, Direction p_226221_, int p_226222_, int p_226223_) {
      ...
      for(int l = p_226222_; l < p_226216_ && p_226223_ > 0; --p_226223_) {
         if (l >= 1) {
            ...
            p_226218_.add(new WorldShipFoliagePlacer.FoliageAttachment(p_226219_.immutable(), 0, false));
         }
      ...
      if (i - p_226220_ > 1) {
         ...
         p_226218_.add(new WorldShipFoliagePlacer.FoliageAttachment(blockpos, 0, false));
         p_226218_.add(new WorldShipFoliagePlacer.FoliageAttachment(blockpos.below(2), 0, false));
      }
