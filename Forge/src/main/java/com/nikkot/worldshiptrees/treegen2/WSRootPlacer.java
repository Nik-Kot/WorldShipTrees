...
public class WSRootPlacer extends RootPlacer {
   public static final int ROOT_WIDTH_LIMIT = 8;
   public static final int ROOT_LENGTH_LIMIT = 15;
   public static final Codec<WSRootPlacer> CODEC = RecordCodecBuilder.create((p_225856_) -> {
      ...
      })).apply(p_225856_, WSRootPlacer::new);
   });
   private final MangroveRootPlacement mangroveRootPlacement;

   public WSRootPlacer(IntProvider p_225817_, BlockStateProvider p_225818_, Optional<AboveRootPlacement> p_225819_, MangroveRootPlacement p_225820_) {
   ...
   public boolean placeRoots(LevelSimulatedReader p_225840_, BiConsumer<BlockPos, BlockState> p_225841_, RandomSource p_225842_, BlockPos p_225843_, BlockPos p_225844_, WSTreeConfiguration p_225845_) {
      List<BlockPos> list = Lists.newArrayList();
      BlockPos.MutableBlockPos blockpos$mutableblockpos = p_225843_.mutable();
   ...
   protected void placeRoot(LevelSimulatedReader p_225834_, BiConsumer<BlockPos, BlockState> p_225835_, RandomSource p_225836_, BlockPos p_225837_, WSTreeConfiguration p_225838_) {
      if (p_225834_.isStateAtPosition(p_225837_, (p_225847_) -> {
         return p_225847_.is(this.mangroveRootPlacement.muddyRootsIn());
      })) {
         BlockState blockstate = this.mangroveRootPlacement.muddyRootsProvider().getState(p_225836_, p_225837_);
         ...
         if (this.canPlaceRoot(p_225834_, p_225837_)) {
            p_225835_.accept(p_225837_, this.getPotentiallyWaterloggedState(p_225834_, p_225837_, this.rootProvider.getState(p_225836_, p_225837_)));
            if (this.aboveRootPlacement.isPresent()) {
               AboveRootPlacement aboverootplacement = this.aboveRootPlacement.get();
               BlockPos blockpos = p_225837_.above();
               if (p_225836_.nextFloat() < aboverootplacement.aboveRootPlacementChance() && p_225834_.isStateAtPosition(blockpos, BlockBehaviour.BlockStateBase::isAir)) {
                  p_225835_.accept(blockpos, this.getPotentiallyWaterloggedState(p_225834_, blockpos, aboverootplacement.aboveRootProvider().getState(p_225836_, blockpos)));
               }
            }
         }
      }
