...
public class WSTreeDecorator extends TreeDecorator {
   public static final Codec<WSTreeDecorator> CODEC = Codec.floatRange(0.0F, 1.0F).fieldOf("probability").xmap(WSTreeDecorator::new, (p_226037_) -> {
   ...
   public WSTreeDecorator(float p_226031_) {
      this.probability = p_226031_;
   }

   public void place(Context p_226039_) {
   ...
   private static void addHangingVine(BlockPos p_226041_, BooleanProperty p_226042_, Context p_226043_) {
